...
{
    public class EffectText : Component<WorldScene>
    {
        ...
        public string text
        {
            ...
            {
                _text = value;
                scene.font.content.UpdateText(ref geo, value, LayoutInfo.BOTTOM);
            }
        }
        ...
        void DrawText()
        {
            ...
            scene.view.SetValues(scene.textShader, Matrix.Scaling(0.2f) * scene.view.yBillBoard * Matrix.Translation(position));
